...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        } else if(getGeoLocation?.loaded) currentLocation = [getGeoLocation?.coordinates.lat, getGeoLocation?.coordinates.lon]

        dispatch(setLocation(currentLocation))

    }, [dispatch, getGeoLocation?.coordinates.lat, getGeoLocation?.coordinates.lon, getGeoLocation?.loaded, locationState])
